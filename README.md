...
##### What are the advantages or disadvantages of refactoring code?
    -The advantages are certainly improved code. We were able to leverage arrays to provide our output.

##### How do these pros and cons apply to refactoring the original VBA script?
    -In this particular example we established quicker run times which will allow us to analyze more information and additiona years.
